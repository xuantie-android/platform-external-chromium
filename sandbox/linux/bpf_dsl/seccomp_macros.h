...
// RISC-V register mapping follows Chromium review 4935120, patchset 3.
// Bionic and glibc expose the same __gregs layout in ucontext_t.
struct regs_struct {
...
#define SECCOMP_IP(_ctx) SECCOMP_REG(_ctx, REG_PC)
